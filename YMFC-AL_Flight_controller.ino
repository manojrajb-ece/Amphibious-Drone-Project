...
PORTB |= B00001000;
 ...
 while((PORTD & B01110000) || (PORTB & B00001000)){
  esc_loop_timer = micros();

  if(timer_channel_1 <= esc_loop_timer) PORTD &= B11101111;   // D4
  if(timer_channel_2 <= esc_loop_timer) PORTD &= B11011111;   // D5
  if(timer_channel_3 <= esc_loop_timer) PORTD &= B10111111;   // D6
  if(timer_channel_4 <= esc_loop_timer) PORTB &= B11110111;   // D11
}
